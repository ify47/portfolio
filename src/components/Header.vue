...
const scrollPageTo = (nav: string) => {
    let element: HTMLElement | null = document.querySelector(`#${nav}`);
            ...
            <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div class="relative flex h-16 items-center justify-between">
                    <div class="absolute inset-y-0 right-0 flex items-center sm:hidden">
                        <!-- Mobile menu button-->
                        <DisclosureButton
                            class="relative inline-flex items-center justify-center rounded-md p-2 text-black  focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                    ...
                    <div class="flex flex-1 items-center sm:items-stretch sm:justify-start">
                        ...
                        <div class="relative ml-3">
                            <span
                                ...
                                <img class="h-10 w-10 rounded-full" src="../assets/uniqueIcon.jpeg" alt="my Unique Icon" />
                            </span>
                        </div>
                    </div>
